  ...
  return (
    <div className="fade-in">
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-8">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-400">Core Protocol</span>
      </div>

      <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tighter">Bias Mitigation</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
         <div className="glass-card p-8 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
            ...
            <GitCompare size={32} className="text-emerald-400 mb-6" />
            ...
            <div className="text-[10px] font-black uppercase tracking-widest text-emerald-500/50">Stage: Pre-processing</div>
         </div>

         <div className="glass-card p-8 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-indigo-500/30 transition-colors">
            ...
            <GitMerge size={32} className="text-indigo-400 mb-6" />
            ...
            <div className="text-[10px] font-black uppercase tracking-widest text-indigo-500/50">Stage: Post-processing</div>
         </div>
      </div>
